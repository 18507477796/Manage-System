...
%>
<form action="gonggaoxinxi_updt.jsp?f=f&id=<%=mmm.get("id")%>" method="post" name="form1"
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            <td>标题：</td>
            <td><input name='biaoti' type='text' id='biaoti' size='50' value='<%=mmm.get("biaoti")%>'
                       style='border:solid 1px #000000; color:#666666'/></td>
        </tr>
        <tr>
            <td>内容：</td>
            <td><textarea name="neirong" cols="100" rows="8"
                          style="width:700px;height:200px;visibility:hidden;"><%=mmm.get("neirong")%></textarea></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
