...
<form name="form1" id="form1" method="post" action="">
    ...
    <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666'/> <input type="button"
                                                                                                           ...
                                                                                                           onClick="javascript:location.href='gonggaoxinxi_listxls.jsp';"/>
</form>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF"
    ...
    <%
        ...
        if (request.getParameter("biaoti") == "" || request.getParameter("biaoti") == null) {
            ...
            sql = sql + " and biaoti like '%" + request.getParameter("biaoti") + "%'";
        }
    ...
    <tr>
        ...
        <td width="60" align="center"><a href="gonggaoxinxi_updt.jsp?id=<%=map.get("id")%>">修改</a> <a
                href="gonggaoxinxi_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a
                href="gonggaoxinxi_detail.jsp?id=<%=map.get("id")%>">详细</a></td>
    </tr>
    <%
        }
    %>
