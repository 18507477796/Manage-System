...
<form name="form1" id="form1" method="post" action="">
    ...
    <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666'/> <input type="button"
                                                                                                           ...
                                                                                                           onClick="javascript:location.href='qingjiaxinxi_listxls.jsp';"/>
</form>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF"
    ...
    <tr>
        ...
        <td width="60" align="center"><a href="qingjiaxinxi_updtlb.jsp?id=<%=map.get("id")%>">回复</a> <a
                href="qingjiaxinxi_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a
                href="qingjiaxinxi_detail.jsp?id=<%=map.get("id")%>">详细</a></td>
    </tr>
    <%
        }
    %>
