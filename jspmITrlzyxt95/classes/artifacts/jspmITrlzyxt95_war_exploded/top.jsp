...
<div class="top_box">
    <div class="top_logo">
        <div align="center" style="color: #CCFFCC;font-size: 15pt;font-weight: bold;">人力资源系统</div>
    </div>
    <div class="top_nav">
        <div class="top_nav_sm">
            <span style="float:right; padding-right:12px"> [<a href="index.jsp" target='_parent'><strong>首页</strong></a>]  </span>
            你好！<%=request.getSession().getAttribute("username")%> [<%=request.getSession().getAttribute("cx")%>] &nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;
        </div>
    ...
    <div class="top_bar"><input onClick="switchBar(this)" type="button" value="关闭左边菜单" name="SubmitBtn" class="bntof"/>
        <div class="top_she">
            <a href="javascript:void(0);" onClick="self.top.location.href='logout.jsp'">安全注销</a> <a
                onClick="javascript:window.parent.main.history.go(-1);" style="cursor:pointer;">前进一页</a>
