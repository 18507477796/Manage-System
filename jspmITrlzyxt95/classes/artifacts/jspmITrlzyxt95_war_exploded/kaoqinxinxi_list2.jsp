...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF"
    ...
    <%
        ...
        String url = "kaoqinxinxi_list2.jsp?1=1";
        String sql = "select * from kaoqinxinxi where gonghao='" + request.getSession().getAttribute("username") + "' ";
    ...
    <tr>
        ...
        <td width="60" align="center"><a href="kaoqinxinxi_updt.jsp?id=<%=map.get("id")%>">修改</a> <a
                href="kaoqinxinxi_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a
